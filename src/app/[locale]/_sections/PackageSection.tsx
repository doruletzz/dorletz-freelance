  ...
  return (
    ...
    <div className="grid grid-cols-3 gap-3 mt-16">
      ...
      <Card variant="yellow" className="group">
        ...
        <span className="text-lg font-black font-display text-yellow-800">{CARD_HEADING_2}</span>
      ...
      <Card variant="blue" className="group">
        ...
        <span className="text-lg font-black font-display text-sky-800">{CARD_HEADING_3}</span>
